...
class AudioFile extends StatefulWidget {
  ...
  final audiopath;
  AudioFile({this.audiopath, required this.advancedPlayer});

  @override
  State<AudioFile> createState() => _AudioFileState(audiopath);
}
...
List<IconData>_icons=[
  ...
  _AudioFileState(this.audiopath);
  final audiopath;
  ...
  void initState(){
    ...
    this.widget.advancedPlayer.setSourceUrl(audiopath);
  }
  Widget btnStart(){
  // isplaying=bool;
  ...
  return IconButton(
      ...
      onPressed:(){
        if(isplaying == false){
        this.widget.advancedPlayer.play(UrlSource(audiopath));
  setState((){
   isplaying=true;
 });
